#
#  Be sure to run `pod spec lint AppDevHistogram.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/cuappdev/AppDevHistogram.git", :tag => spec.version.to_s }
  ...
  spec.source_files  = "AppDevHistogram/Classes/*.swift", "AppDevHistogram/Classes/**/*.{h,m}"
